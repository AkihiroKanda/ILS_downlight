...
public class InitialValue {
	...
	public final static double  MAX_K = 6000;							//最大点灯色温度
	public final static double  MIN_K = 2700;							//最小点灯色温度
	public final static double  MAX_M = 1000000.0/6000.0;				//最大点灯色温度
	public final static double  MIN_M = 1000000.0/2700.0;				//最小点灯色温度

	//照度センサの設定
	public final static int MAX_TARGET_LX = 1500;						//目標照度の上限値
	public final static int MIN_TARGET_LX = 200;						//目標照度の下限値

	public final static int MAX_TARGET_K = 5500;						//目標色温度の上限値
	public final static int MIN_TARGET_K = 3000;						//目標色温度の下限値

	//最急降下法
	public final static int MAX_STEP =100;									//最大ステップ数
	...
	public final static double WEIGHT = 10;								//目的関数の重み．とりあえず1に設定
	public final static double INITIAL_X1 = 0;
	public final static double INITIAL_STEP_SIZE = 5;
